...
<html lang="es">
	<head>
  	...
  	<?php $current = 'contacto'; ?>
		...
		<title>Gracias Newsletter - Imprac</title>
	</head>
							...
							<h1 class="h2_electronica margin_top_30 margin_bottom_30 ">ENVIO EXITOSO</h1>
								...
								<p>
									<span class="frase_slide_menor">
										Para nosotros es un gran placer recibir una nueva suscripción, estamos muy contentos de contar con la oportunidad de entablar este vínculo. <br>
