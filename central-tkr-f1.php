...
<html lang="es">
	<head>
		...
		<meta name="description" content="Central electronica para motores de porton de uso domiciliario - TKR-F1.">
		...
		<title>Central electronica TKR-F1. Para automatizacion de portones.</title>
	</head>
				...
				<div class="row">
					...
					<div class="col-md-12 text-center align_vertical_horizontal">
						<div>
							...
							<img class="titulo_central" src="img/electronica/centrales/tkr-f1-titulo-principal.png" alt="tkr-f1 central electronica para portones automaticos">
						</div>
					</div>
					...
					<div class="col-md-6 align_vertical_top">
						<div class="parent-container">
							<div class="col-md-12 margin_bottom_60">
								<a title="Central TKR - IMPRAC" href="img/electronica/centrales/central-tkr-f1-gr.jpg">
									<img class="w-100" src="img/electronica/centrales/central-tkr-f1-gr.jpg">
								</a>
							</div>
							<div class="row margin_bottom_60">
								<div class="col-sm-6 col-md-12 col-lg-6 text center">
									<a title="Central TKR - IMPRAC" href="img/electronica/centrales/central-tkr-f1-bottom-a.jpg">
										<img class="w-100" src="img/electronica/centrales/central-tkr-f1-bottom-a.jpg">
									</a>
								</div>
								<div class="col-sm-6 col-md-12 col-lg-6 text center">
									<a title="Central TKR - IMPRAC" href="img/electronica/centrales/central-tkr-f1-bottom-b.jpg">
										<img class="w-100" src="img/electronica/centrales/central-tkr-f1-bottom-b.jpg">
									</a>
								</div>
							</div>
						</div>
					...
					<div class="col-md-6 align_vertical_horizontal">
						<div>
							<p class="parrafo_descripcion_textos">
								...
								controlar la línea de motores Tankker, posee posibilidad de lectura de fin de carrera SMART HALD (sensor inteligente detección automática apertura/cierre). Central electrónica full, con arranque y parada suave. El modelo F1 equipada con 3 tipos de desaceleración para el control de motores de alta velocidad. 
							</p>
							...
							<ul class="parrafo_descripcion_textos">
								...
								<li>Salida 12Vca para manejo de accesorios (no apta cerradura)</li>
								...
								<li>Desaceleración diferenciada apertura/cierre</li>
								<li>Cierre Automático Configurable hasta 2 Minutos</li>
							</ul>
						</div>
					</div>
					...
					<div class="col-md-12 text-center align_vertical_horizontal">
						<div>
							<div class="contenedor_plano">
								...
								<img class="w-100" src="img/electronica/centrales/central-tkr-f1-plano.jpg" alt="plano central tkr-f1">
