...
<html lang="es">
	<head>
		...
		<meta name="description" content="Automatizacion e insumos para portones levadizos modelo up-10 de Imprac.">
		...
		<title>Automatismo para porton levadizo UP-10 - IMPRAC.</title>
	</head>
				...
				<div class="row">
					...
					<div class="col-md-12 text-center align_vertical_horizontal">
						<div>
							...
							<img class="titulo_central" src="img/automatizacion/levadizos/up-10-titulo-ind.png" alt="motor para porton levadizo">
						</div>
					</div>
			...
			<div class="container">
				<div class="row ">
					...
					<div class="col-md-6 text-center">
						<img class="w-100" src="img/automatizacion/levadizos/up-10-individual.jpg" alt="levadizo up 10">
					</div>
