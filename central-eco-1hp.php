				...
				<div class="row">
					...
					<div class="col-md-12 text-center align_vertical_horizontal">
						<div>
							...
							<img src="img/electronica/centrales/eco-1hp-titulo-principal.png" alt="ECO central electronica para portones automaticos">
						</div>
					</div>
					...
					<div class="col-md-6 align_vertical_top">
						<div class="parent-container">
							<div class="col-md-12 margin_bottom_60">
								<a title="Central ECO 1HP - IMPRAC" href="img/electronica/centrales/central-tkr-gr.jpg">
							...
							<div class="row margin_bottom_60">
								<div class="col-sm-6 col-md-12 col-lg-6 text center">
									<a title="Central ECO 1HP - IMPRAC" href="img/electronica/centrales/central-tkr-bottom-a.jpg">
										<img class="w-100" src="img/electronica/centrales/central-tkr-bottom-a.jpg">
									</a>
								</div>
								<div class="col-sm-6 col-md-12 col-lg-6 text center">
									<a title="Central ECO 1HP - IMPRAC" href="img/electronica/centrales/central-tkr-bottom-b.jpg">
