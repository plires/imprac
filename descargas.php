...
<!-- Modal -->
<?php // include_once('includes/modal_descargas.inc'); ?>
...
<html lang="es">
	<head>
		...
		<?php $current = 'descargas'; ?>

		<!-- Required meta tags -->
		<meta charset="utf-8">
		<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
		<meta name="description" content="descarga de manuales para la correcta instalacion de centrales y equipos.">
		...
		<title>Descargas de Manuales e Instructivos para motores Imprac</title>
	</head>
	...
	<body>
  	...
  	<?php include_once("includes/tag_manager_head.inc"); ?>
		...
		<section class="container-fluid fondo_descargas">
			<div class="container padding_top_60">
				<div class="row">
					
					<div class="col-md-8 offset-md-2 text-center align_vertical_horizontal">
						<div>
							<h2 class="h2_electronica h2_repuestos margin_top_30 margin_bottom_60 ">DESCARGAS</h2>
								<p>
									<span class="frase_slide_mayor">
										Encontrá aquí todo el material necesario para la correcta instalación.
									</span>
								</p>

								<p class="parrafo_descargas">
									Ponemos a tu disposición todos los manuales
									e instrucciones para una adecuada instalación
									y un buen uso de nuestros sistemas de automatización
								</p>
		...
		<!-- Faja Download Texto -->
		<section class="container margin_bottom_60 descargas">

			<div class="row margin_bottom_60">
				<div class="col-sm-12 text-center">
					<img class="img-fluid" src="img/descargas/manuales.gif">
					<h1 class="h1_descargas margin_top_30 margin_bottom_60 ">MANUALES</h1>
				</div>	
			</div>
