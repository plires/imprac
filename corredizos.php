...
<html lang="es">
	<head>
		...
		<meta name="description" content="automatizacion para portones corredizos Imprac. Venta de equipos y repuestos originales.">
		...
		<title>Automatizacion para portones corredizos.</title>
	</head>
	...
	<body>
  	...
  	<?php include_once 'includes/tag_manager_head.inc'; ?>
		...
		<section class="container-fluid fondo_levadizo corredizo">
			<div class="container">

				<div class="row">
					<div class="col-md-12 text-center align_vertical_horizontal">
						<div>
							<h2 class="h2_electronica h2_motores h2_corredizo">SISTEMA CORREDIZO</h2>
							<div class="col-md-6 offset-md-3">
								<p>
									<span class="frase_slide_mayor">
										Amplia variedad de modelos. Sistemas ultra-rápidos
									</span>
								</p>
							</div>
						</div>
				...
				<div class="row">
					<div class="col-md-12 text-center">
						<img src="img/automatizacion/corredizos/icono-corredizo.png" alt="icono automatizacion corredizos">
					</div>
				</div>
		...
		<!-- Faja texto de corredizos -->
		<section class="container margin_top_30 margin_bottom_60">
			<div class="row">
				<div class="col-md-6 offset-md-3 text-center">
					<p class="parrafo_familia_home">
						Nuestra línea permite la automatización
						de portones desde 400 kg. hasta 1500 kg. de peso.
						También contamos con sistemas ultra-rápidos
					</p>
				</div>
			</div>
		</section>
		<!-- Faja texto de corredizos end-->
		...
		<!-- Faja familia de corredizos end-->
